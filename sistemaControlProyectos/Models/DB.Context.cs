...
namespace sistemaControlProyectos.Models
{
    ...
    public partial class DBControlProyectoEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> SP_A_PERMISOS(Nullable<int> iDCargo, Nullable<int> iDSubMenu)
        {
            ...
            var iDSubMenuParameter = iDSubMenu.HasValue ?
                ...
                new ObjectParameter("IDSubMenu", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("SP_A_PERMISOS", iDCargoParameter, iDSubMenuParameter);
        }
        ...
        public virtual ObjectResult<string> SP_A_SUBMENU(Nullable<int> iDMenu, string nombreSubMenu, string controlador, string vista, Nullable<bool> edicion)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("SP_A_SUBMENU", iDMenuParameter, nombreSubMenuParameter, controladorParameter, vistaParameter, edicionParameter);
        }
